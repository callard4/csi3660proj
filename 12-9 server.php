...
$db = mysqli_connect('localhost', 'root', 'PASSWORD', 'project');
...
if (isset($_POST['login_user'])) {
        ...
        if (count($errors) == 0) {
                ...
                if (mysqli_num_rows($results) == 1) {
                        ...
                        logEvent("Login Failed", "User attempted to logged in: $username");
        ...
        $stmt->close();
        $db->close();
        logEvent("Login successful", "User logged in: $username");
}
